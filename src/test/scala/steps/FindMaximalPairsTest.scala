...
class FindMaximalPairsTest extends FunSuite {
  ...
  test("Check all possible Causal Groups Combinations") {
    val causalGroups = List(
      new CausalGroup[String](Set("E"), Set("D")),
      new CausalGroup[String](Set("B"), Set("D")),
      new CausalGroup[String](Set("A"), Set("B", "E")),
    ...
    val findMaximalPairs: FindMaximalPairs = new FindMaximalPairs(causalGroups)
    val groupCombinations = findMaximalPairs.possibleCausalGroupsCombinations()

    assert(groupCombinations.contains((new CausalGroup[String](Set("E"), Set("D")), new CausalGroup[String](Set("B"), Set("D")))))
    assert(groupCombinations.contains((new CausalGroup[String](Set("E"), Set("D")), new CausalGroup[String](Set("A"), Set("B", "E")))))
    assert(groupCombinations.contains((new CausalGroup[String](Set("E"), Set("D")), new CausalGroup[String](Set("A"), Set("C", "E")))))
    assert(groupCombinations.contains((new CausalGroup[String](Set("B"), Set("D")), new CausalGroup[String](Set("A"), Set("B", "E")))))
    assert(groupCombinations.contains((new CausalGroup[String](Set("B"), Set("D")), new CausalGroup[String](Set("A"), Set("C", "E")))))
    assert(groupCombinations.contains((new CausalGroup[String](Set("A"), Set("B", "E")), new CausalGroup[String](Set("A"), Set("C", "E")))))

    assert(groupCombinations.contains((new CausalGroup[String](Set("B"), Set("D"))), new CausalGroup[String](Set("E"), Set("D"))))
    assert(groupCombinations.contains((new CausalGroup[String](Set("A"), Set("B", "E"))), new CausalGroup[String](Set("E"), Set("D"))))
    assert(groupCombinations.contains((new CausalGroup[String](Set("A"), Set("C", "E")), new CausalGroup[String](Set("E"), Set("D")))))
    assert(groupCombinations.contains((new CausalGroup[String](Set("A"), Set("B", "E")), new CausalGroup[String](Set("B"), Set("D")))))
    assert(groupCombinations.contains((new CausalGroup[String](Set("A"), Set("C", "E")), new CausalGroup[String](Set("B"), Set("D")))))
    assert(groupCombinations.contains((new CausalGroup[String](Set("A"), Set("C", "E")), new CausalGroup[String](Set("A"), Set("B", "E")))))

    assert(groupCombinations.size==12)
  }
